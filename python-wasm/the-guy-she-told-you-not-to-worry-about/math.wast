...
(; ⠀⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡁⠈⠢⡀⠀⠀⠀⠀⡂⠀⠀⠀⠀⠀⣀⠴⠉⠀⠀⠀⠀ ;)
(; ⠀⠇⠀⢀⠀⡀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⢀⠀⡂⠀⡀⠈⡑⠢⠤⢄⠆⠤⠤⠔⢒⠉⡀⢀⠀⡀⢀⠀⡀ ;)
  (func $fibonacci (export "fibonacci") (param $n i64) (result i64)
     (local $first i64)
     (local $second i64)
  ...
  (func $circumference (export "circumference") (param $r f32) (result f32)
     (f32.mul (f32.mul (global.get $pi) (local.get $r)) (f32.const 2)))

  (func $circlesurface (export "circleSurface") (param $r f32) (result f32)
     ;; first I say I multiply a lot
     (f32.mul (f32.mul
        ;; then I say what I multiply a lot
        (local.get $r) (local.get $r)) (global.get $pi)))

  (func $sphereV (export "sphereVolume") (param $r f32) (result f32)
  ;; V = 4/3*π*r³
     (f32.mul
       (f32.mul
